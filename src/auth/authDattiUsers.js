...
router.post('/', async (req, res) => {
  ...
  const createQuery = `INSERT INTO
    dattiusers(name,fname,lname,oname,  email, password, gender, created_at, phone_no,user_access,account_role,remember_token,current_team_id,updated_at,profile_photo_path,email_verified_at, state,ward)
